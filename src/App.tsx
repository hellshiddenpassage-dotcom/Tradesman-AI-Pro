...
> = {
  English: {
    ...
    currencyNote: "All pricing is an estimate and should be reviewed before sending.",
  },
  Spanish: {
    ...
    currencyNote: "Todos los precios son estimados y deben revisarse antes de enviarlos.",
  },
  French: {
    ...
    currencyNote: "Tous les prix sont estimatifs et doivent être vérifiés avant envoi.",
  },
  German: {
    ...
    currencyNote: "Alle Preise sind Schätzungen und sollten vor dem Versand geprüft werden.",
  },
  Portuguese: {
    ...
    currencyNote: "Todos os preços são estimados e devem ser revisados antes do envio.",
  },
};
...
function detectJobType(description: string): string {
  ...
  if (text.includes("demo") || text.includes("demolition") || text.includes("remove")) return "Demolition / Removal";
  if (text.includes("excavat") || text.includes("dig") || text.includes("trench")) return "Excavation";
  if (text.includes("alternator") || text.includes("repair") || text.includes("mechanic")) return "Mechanical Repair";
  ...
  return (
    ...
    >
      ...
      <p style={{ color: "#4b5563", marginTop: 0 }}>
        AI-style business tools for contractors, mechanics, and trades professionals.
      </p>
      ...
      >
        ...
        <div style={{ color: "#6b7280", fontSize: 13, marginBottom: 12 }}>
          ...
          The built-in translator works best on app-generated estimate text.
        </div>
